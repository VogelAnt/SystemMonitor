...
DeviceTabWidget::DeviceTabWidget(QWidget *parent) : QTabWidget(parent) {
    ...
    //        DisplayName_NodeId_SeedSupplySkills["moveToSTHomePosition"]  =
    //        "::AsGlobalPV:opcComMitsubishi.skill.moveToSTHomePosition.state.stateMachine.operationalState";
    //        DisplayName_NodeId_SeedSupplySkills["provideItemFromSTToWelding"]  =
    //        "::AsGlobalPV:opcComMitsubishi.skill.provideItemFromSTToWelding.state.stateMachine.operationalState";
    //        DisplayName_NodeId_SeedSupplySkills["provideItemFromWeldingToST"]  =
    //        "::AsGlobalPV:opcComMitsubishi.skill.provideItemFromWeldingToST.state.stateMachine.operationalState";
    //        DisplayName_NodeId_SeedSupplySkills["provideItemToST"]  =
    //        "::AsGlobalPV:opcComMitsubishi.skill.provideItemToST.state.stateMachine.operationalState";
    //        DisplayName_NodeId_SeedSupplySkills["provideItemToWelding"]  =
    //        "::AsGlobalPV:opcComMitsubishi.skill.provideItemToWelding.state.stateMachine.operationalState";
    ...
    //        DeviceWidget *SeedSupplyTab = new DeviceWidget(uaClientSeedSupply, DisplayName_NodeId_SeedSupply, DisplayName_NodeId_SeedSupplySkills, 6, 3,
    //        this);
