...
SkillListWidget::SkillListWidget(UA_Client* client,
    ...
    connect(DeviceInfo, &DeviceInformation::UpdateUiDeviceState, this, &SkillListWidget::on_UpdateDeviceUI);
    connect(DeviceInfo, &DeviceInformation::UpdateUiSkillState, this, &SkillListWidget::on_UpdateSkillsUI);
...
void SkillListWidget::on_UpdateSkillsUI(std::string nodevalue, std::pair<char *, char *>pair){
...
//
void SkillListWidget::on_UpdateDeviceUI(std::string nodevalue, std::pair<char *, char *>pair){
